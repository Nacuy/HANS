...
export function CalendarWeekView({ singleDayEvents, multiDayEvents }: IProps) {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center border-b border-border py-4 text-sm text-muted-foreground sm:hidden">
      ...
      <div className="hidden flex-col sm:flex">
        <div>
          ...
          <div className="relative z-20 flex border-b border-border">
            ...
            <div className="grid flex-1 grid-cols-7 divide-x divide-border border-l border-border">
                      ...
                      {hours.map((hour, index) => {
                        ...
                        return (
                          <div key={hour} className={cn("relative", isDisabled && "bg-calendar-disabled-hour")} style={{ height: "96px" }}>
                            {index !== 0 && <div className="pointer-events-none absolute inset-x-0 top-0 border-b border-border/70"></div>}
